...
- Select from recommended research questions, which are based on the information in your [personal profile](/content/docs/getting-started-guide/profile-setup.md).
