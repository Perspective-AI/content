---
title: "Creating an Interviewer Agent"
...
2. From the agent type options, select **Interviewer**
...
![Agent type selection showing Interviewer highlighted](/images/agent-selection-gif.gif "animated")
*Select Interviewer for exploratory, qualitative research.*
...
2. Answer thoughtfully as a target participant might
3. Evaluate:
