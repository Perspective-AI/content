...
For technical teams using AI-assisted development tools, you can integrate via the [**Perspective AI MCP server**.](/docs/guide/operations/mcp) This lets you add embed code directly from Cursor, Codeium, Claude Code, or any IDE supporting custom MCPs.
