---
title: "Inviting Participants to Your Research"
...
<div style="padding:62.28% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1133247496?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Invite Participants to Your Research"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
...
1. Click **Invite Participants** from your research outline
2. Select **Invite with a Link**
3. Copy the generated participation link
4. Share the link through your chosen channels

![Link invitation URL](/images/invite-link.png "screenshot")
...
1. Click **Invite Participants** from your research outline
2. Select **Email Invitations**
3. Add participants using one of three options:
...
4. Move to the **Compose Message** step
5. Review the auto-generated subject line and message
6. Edit the invitation text if needed to match your tone or add context
7. Click **Send Test Message** to preview how the invitation will appear
8. When satisfied, click **Send Invitation**

![Email invitation interface with participant selection](/images/invite-participants-gif.gif "animated")
